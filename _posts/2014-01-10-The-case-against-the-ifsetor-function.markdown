...
So what the `$array[0][1][2] = 'foobar'` assignment really does it something along these lines (obviously heavily
simplified):
...
Personally I think that this actually the least of the issues, because typical default values are simple falsy values
